...
-->
	...
	<body>
		<div id="outer">
			...
			<div id="banner">
				<img src="images/wedding-dj.jpg" width="1180" height="320" alt="" />
			...
			<div id="main">
				<div id="content">
					...
					<div id="box1"><h2 align="center">Event management</h2><img class="left" src="images/Reception-Lighting-Ideas.jpg" width="200" height="180" alt="" /><p style="font-size:16px;">Events like wedding,  birthday, anniversary etc are the special moments of life that makes life memorable.These  moments are recognized with traditional ceremonies.To make these auspicious events memorable our site provides you the highest quality services and  information.Whatever your event needs may be , our team is ready to offer personalised information to help make your event day the most memorable day of your life.</p>
<p style="font-size:16px;">Event planning is required at every step for perfect arrangement of events, planning  a successful event requires lots of preparation and everybody wants it should go off without a glitch.</p>
					...
					<!--<img class="left" src="images/pic04.jpg" width="200" height="180" alt="" />-->
					 <p class="style4" ><FONT color="#000000">Event Manangement provides:-</font> </p>
	...
	<LI>Transportation and other services<br></LI>
				...
				<h2 align="center" style="color:#98ae5b;">dj Service</h2></div>
  ...
  <?php 
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='dj/sound'");
        ...
        <td width="300" height="201"><table width="200" height="198" border="0">
          <tr>
            <td width="329"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/celebrity.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center">
                     <span class="style1">
                    <input type="checkbox" name="c1[]" value="celebrityshow">
                    celebrity show <br>
            ...
            <td width="332"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/Folder.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center" class="style1">
                    <input type="checkbox" name="c1[]" value="rockband">
                    Rock Band                 </div>
                  <span class="style1">
                  </label>
                  </span>
          ...
          <tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/Folde1r.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="djsystem">
                      <label><span class="style1">Dj system </span></label>
                    </div>
                    <span class="style1">
                    </label>
                    </span>
            ...
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/classicalshow.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="classical">
                      <span class="style1">classical show                      </span></div>
                    <span class="style1">
                    </label>
                    </span>
                    <p align="center" class="style1">price:-<?php echo $a[3] ?></p></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
