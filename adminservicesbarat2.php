...
<div id="outer">
    ...
    <div id="main" style="height:400px">
        <table width="240" border="0" cellspacing="5" cellpadding="10" class="tab2" >
            <tr>
                <td>
                    <th width="113" scope="col"><img border="0" src="images/services_subtype/ghori.jpg"  alt="d" width="113" height="140"></th>
                    <th width="106" scope="col"><span class="style1">ghori</span></th>
                </td>
                <td></td>
                <td>
                    <th width="113" scope="col"><img border="0" src="images/services_subtype/baraatband.jpg"  alt="d" width="113" height="140"></th>
                    <th width="106" scope="col"><span class="style1">Baratband</span></th>
                </td>
            </tr>
        </table>
    </div>
