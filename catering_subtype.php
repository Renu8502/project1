...
-->
	...
	<body>
		<div id="outer">
			...
			<div id="banner">
				<img src="images/Wedding-Catering-Services.jpg" width="1180" height="320" alt="" />
...
<p style="font-size:16px;">Event planning is required at every step for perfect arrangement of events, planning  a successful event requires lots of preparation and everybody wants it should go off without a glitch.</p>
	...
	<LI>Transportation and other services<br></LI>
				...
				<h2 align="center" style="color:#98ae5b;">catering Service</h2></div>
				<br />
  ...
  <?php 
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='catering'");
        ...
        <td width="300" height="201"><table width="200" height="198" border="0">
          <tr>
            <td width="329"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/indian_food.gif"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center">
                     <span class="style1">
                    <input type="checkbox" name="c1[]" value="vegiterian">
                    Vegeterian Meal <br>
            ...
            <td width="332"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/Non Veg.JPG"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center" class="style1">
                    <input type="checkbox" name="c1[]" value="nonvegiterian">
                     Non Vegeterian Meal              </div>
                  <span class="style1">
                  </label>
                  </span>
          ...
          <tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/south-indian-recipe.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="southindian">
                      <label><span class="style1">South Indian </span></label>
                    </div>
                    <span class="style1">
                    </label>
                    </span>
            ...
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/soda-can.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="softdrinks">
                      <label><span class="style1"> soft drinks                 </span></label></div>
                    <span class="style1">
                    </label>
                    </span>
                    <p align="center" class="style1">price:-<?php echo $a[3] ?></p></td></tr></table></td>
					<tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/sweetdish.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="sweetdish">
                      <label><span class="style1">  sweetdish               </span></label></div>
                    <span class="style1">
                    </label>
                    </span>
                    <p align="center" class="style1">price:-<?php echo $a[4] ?></p></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
