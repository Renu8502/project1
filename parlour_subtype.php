...
<p style="font-size:16px;">Event planning is required at every step for perfect arrangement of events, planning  a successful event requires lots of preparation and everybody wants it should go off without a glitch.</p>
	...
	<LI>Transportation and other services<br></LI>
				...
				<h2 align="center" style="color:#98ae5b;">parlour Service</h2></div>
  ...
  <?php 
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='parlour'");
        ...
        <td width="300" height="201"><table width="200" height="198" border="0">
          <tr>
            <td width="329"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/bridal makeup.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center">
                     <span class="style1">
                    <input type="checkbox" name="c1[]" value="bridalmakeup">
                    Bridalmakeup <br>
            ...
            <td width="332"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/mehndi.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center" class="style1">
                    <input type="checkbox" name="c1[]" value="mehandi">
                    Mehndi                 </div>
                  <span class="style1">
                  </label>
                  </span>
          ...
          <tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/hairstyle.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="hairstyle">
                      <label><span class="style1">Hairstyle </span></label>
                    </div>
                    <span class="style1">
                    </label>
                    </span>
            ...
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/jewellery.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="jewellery">
                      <span class="style1">Jewellery                      </span></div>
                    <span class="style1">
                    </label>
                    </span>
                    <p align="center" class="style1">price:-<?php echo $a[1] ?></p></td>
