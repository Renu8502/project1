...
<p style="font-size:16px;">Event planning is required at every step for perfect arrangement of events, planning  a successful event requires lots of preparation and everybody wants it should go off without a glitch.</p>
	...
	<LI>Transportation and other services<br></LI>
				...
				<h2 align="center" style="color:#98ae5b;">card Service</h2></div>
  ...
  <?php 
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='card'");
        ...
        <td width="300" height="201"><table width="200" height="198" border="0">
          <tr>
            <td width="329"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/card/c1.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center">
                     <span class="style1">
                    <input type="checkbox" name="c1[]" value="type1">
                    Type1 <br>
            ...
            <td width="332"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/card/ic2.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center" class="style1">
                    <input type="checkbox" name="c1[]" value="type2">
                    Type2                </div>
                  <span class="style1">
                  </label>
                  </span>
          ...
          <tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/card/wedding_card.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="type3">
            ...
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/services_subtype/card/ic5.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="type4">
                      <span class="style1">Type4                     </span></div>
                    <span class="style1">
                    </label>
                    </span>
