...
<?php
		$a=array();
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='baraat'");
            ...
            <td width="294" height="249"><table width="296" height="194" border="0">
                <tr><td></td><td></td><td></td><td></td><td></td>
                  ...
                  <td width="130"><label>
                    ...
                    <span class="style1"><strong><font size="4"> Ghori</font></strong></span></label>
            ...
            <tr><td width="294"><table width="200" height="194" border="0">
                <tr><td></td><td></td><td>
                  ...
                  <td width="152"><label>
                    ...
                    <span class="style1"><strong><font size="4"> BaratBand</font></strong> </span></label>
