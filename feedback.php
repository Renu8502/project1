...
<form name="fm" method="post" action="feedback1.php">
<table style="border:#000000 solid 2px" class="popo">
<caption><marquee>
<span class="style1">Feedback</span>
</marquee>
</caption>
<tr><th><span class="style2">Name</span></th>
<td><input type="text" name='name' value="">
</td></tr>
<tr><th><span class="style2">Email-id</span></th>
<td><input type="text" name='email' value="">
</td></tr>
<tr>
<th><span class="style2">Type</span></th>
<td>
  <input type="radio" name="radio1" value="complaint" />
  <span class="style2">complaint<br />
  <input type="radio" name="radio1" value="suggestion" />
 suggestion<br />

 <input type="radio" name="radio1" value="feedback" />
 feedback  </span></td>
<tr>
<th><span class="style2">Comments</span></th>
