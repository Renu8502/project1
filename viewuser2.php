...
echo "<center><table border='2' class='tab2'>";
echo "<tr><th>firstname</th><th>lastname</th><th>username</th><th>Address</th><th>pincode</th><th>phoneno.</th><th>city</th><th>state</th><th>Edit</th><th>Delete</th></tr>";
while($res=mysqli_fetch_array($rid))
{

echo "<tr><td>".$res['fname']."</td><td>".$res['lname']."</td><td>".$res['uname']."</td><td>".$res['address']."</td><td>".$res['pcode']."</td><td>".$res['pno']."</td><td>".$res['city']."</td><td>".$res['state']."</td><td><a href='edit.php?id=".$res['regid']."'>Edit"."</a></td>"."<td><a href='delete.php?id=".$res['regid']."'>Delete"."</a></td></tr>";
}
?>
</div>
