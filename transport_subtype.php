...
-->
	...
	<body>
		<div id="outer">
			...
			<div id="banner">
				<img src="images/wedding_transport.jpg" width="1180" height="320" alt="" />
...
<p style="font-size:16px;">Event planning is required at every step for perfect arrangement of events, planning  a successful event requires lots of preparation and everybody wants it should go off without a glitch.</p>
	...
	<LI>Transportation and other services<br></LI>
				...
				<h2 align="center" style="color:#98ae5b;">transport Service</h2></div>
				<br />
  ...
  <?php 
					  ...
					  if (!$con)
						...
						$result=mysql_query("select * from subservices where servicename='transport'");
        ...
        <td width="300" height="201"><table width="200" height="198" border="0">
          <tr>
            <td width="329"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/bus.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center">
                     <span class="style1">
                    <input type="checkbox" name="c1[]" value="bus">
                    Bus service <br>
            ...
            <td width="332"><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/limozin.jpg"  width=118 height=136></td>
                <td width="176"><label>
                  <div align="center" class="style1">
                    <input type="checkbox" name="c1[]" value="limozin">
                    Limousine                 </div>
                  <span class="style1">
                  </label>
                  </span>
          ...
          <tr>
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/hondacity.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="hondacity">
                      <label><span class="style1">hondacity </span></label>
                    </div>
                    <span class="style1">
                    </label>
                    </span>
            ...
            <td><table width="310" height="55" border="0">
              <tr><td></td><td></td><td></td><td></td>
                <td width="118"><IMG  src="images/Mercedes.jpg"  width=118 height=136></td>
                <td width="176"><label>
                    <div align="center">
                      <input type="checkbox" name="c1[]" value="Mercedes">
                      <span class="style1">Mercedes                     </span></div>
                    <span class="style1">
                    </label>
                    </span>
                    <p align="center" class="style1">price:-<?php echo $a[1] ?></p></td>
